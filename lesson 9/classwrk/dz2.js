...
for (const mast of simpsons) {
    let div = document.createElement('div');
    div.classList.add('member');
    div.innerText = `${mast.name} ${mast.surname} ${mast.age}`
...
coursesArray.forEach(item => {
    ...
    item.modules.forEach(module => {
        const moduless = document.createElement('div');
        moduless.innerText = module;
        modulesDiv.appendChild(moduless);
    })
    itemm.append(title, duration, modulesDiv);
